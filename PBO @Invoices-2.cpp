...
int main() {
	cout << "\t\t\t PRICE" <<endl;
	cout << "-------------------------------------------------------------" <<endl<<endl;
	Invoice Invoice1("AB1111","Samsung Galaxy Note 8",3,10100000);
	Invoice Invoice2("CD2222",Samsung Galaxy Note 9",4,14000000);
	...
	cout << "PRICE TOTAL INVOICE Ke 2 ialah Rp. "<< Invoice1.getInvoiceAmount()<<",-" <<endl<<endl;
